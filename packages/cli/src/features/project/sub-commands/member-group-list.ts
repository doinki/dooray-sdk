...
export default defineSubcommand({
  args: {
    page: { description: memberGroupListArgsSchema.shape.page.description, type: 'string', valueHint: 'n' },
    size: { description: memberGroupListArgsSchema.shape.size.description, type: 'string', valueHint: 'n' },
  },
  meta: {
