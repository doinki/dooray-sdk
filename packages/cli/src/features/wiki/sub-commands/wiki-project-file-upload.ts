...
export default defineSubcommand({
  args: {
    'content-type': {
      description: wikiProjectFileUploadArgsSchema.shape.contentType.description,
      type: 'string',
      valueHint: 'mime',
    },
    'file-path': {
      description: wikiProjectFileUploadArgsSchema.shape.filePath.description,
      required: true,
      type: 'string',
      valueHint: 'path',
    },
    type: {
      description: wikiProjectFileUploadArgsSchema.shape.type.description,
